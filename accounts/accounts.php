...
wp_enqueue_style('style', WP_PLUGIN_URL . '/accounts/css/style.css');

wp_enqueue_script('jquery_validate', WP_PLUGIN_URL . '/accounts/js/jquery.validate.min.js');
wp_enqueue_script('additional-methods', WP_PLUGIN_URL . '/accounts/js/additional-methods.min.js');
...
/***********************************************/
class Webgrain {
	public $tabname = 'Associated Employers';
	public $tabicon = 'ae.png';
	public $usertable = 'ae_company';
	public $subusertable = 'ae_user';
}
...
function user_menu() {
	global $webgrain;
	add_menu_page($webgrain->tabname, $webgrain->tabname, 'ae_member_access', 'cm-handle', 'init_order_list', get_settings('siteurl') . '/wp-content/plugins/accounts/' . $webgrain->tabicon, 4);
	add_submenu_page('cm-handle', 'Accounts', 'Accounts', 'ae_member_access',('cm-handle'), 'init_user_list');
	add_submenu_page('cm-handle', 'Sub Accounts', 'Sub Accounts', 'ae_member_access','cm-subuser', 'init_subuser_list');
}
